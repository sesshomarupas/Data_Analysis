...
input1_Abhängigkeit = int(input("Geben Sie 1 für abhängige oder 2 für unabhängige ein: "))
input2_Abhängigkeit = int(input("Wieviele Gruppen möchten Sie vergleichen: "))

independence = input1_Abhängigkeit # 1 = verbunden/abhängig, 2 = unverbunden/unabhängig
